...
# Id: $Id: get-zip-from-wikipedia.pl 631 2015-01-09 13:50:31Z ssimonrubinstein1 $
# Revision: $Revision: 631 $
# Date: $Date: 2015-01-09 13:50:31 +0000 (Fri, 09 Jan 2015) $
# Author: $Author: ssimonrubinstein1 $
# HeadURL: $HeadURL: http://cocobot.googlecode.com/svn/trunk/tools/get-zip-from-wikipedia.pl $
#
