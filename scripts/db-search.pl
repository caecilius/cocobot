...
# Id: $Id: db-search.pl 483 2014-02-15 14:52:16Z ssimonrubinstein1 $
# Revision: $Revision: 483 $
# Date: $Date: 2014-02-15 14:52:16 +0000 (Sat, 15 Feb 2014) $
# Author: $Author: ssimonrubinstein1 $
# HeadURL: $HeadURL: http://cocobot.googlecode.com/svn/trunk/scripts/db-search.pl $
#
